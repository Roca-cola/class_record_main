...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" id="css-main" href="../css/bootstrap.css">
                            ...
                            <ul class="nav-main">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="edit_student.html">Edit/Delete Student</a>
                                        </li>                                        
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="class_record_view.html?subject=CCS341">CCS341</a>
                                                </li>
                                                <li>
                                                    <a href="class_record_view.html?subject=CCS12">CCS12</a>
                                                </li>
                                                <li>
                                                    <a href="class_record_view.html?subject=CCS430">CCS430</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="assignment_student.html">Assign Student</a>
                                        </li>
                                    </ul>
                                </li>                                                                
                            </ul>
